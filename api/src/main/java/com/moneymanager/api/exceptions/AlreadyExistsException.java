...
public class AlreadyExistsException extends RuntimeException {
    ...
    public static final String USERNAME_MESSAGE = "An account with that username already exists";
    public static final String EMAIL_MESSAGE = "An account with that email already exists";
