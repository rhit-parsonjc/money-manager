...
public class TestFinancialTransaction extends FinancialTransaction {
    public TestFinancialTransaction(Long id, Account account, Short yearValue, Byte monthValue, Byte dayValue,
